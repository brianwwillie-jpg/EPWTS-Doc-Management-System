...
$sql = "SELECT * FROM documents WHERE section = 'Admin'";
...
<div class="container mt-5">
    <h2>Administration - Document Management</h2>
    ...
    <div class="alert alert-info">
        ...
        <?php if ($notification_count > 5): ?>
            <button class="btn btn-link p-0 mt-2" type="button" data-bs-toggle="collapse" data-bs-target="#olderNotificationsAdmin" aria-expanded="false" aria-controls="olderNotificationsAdmin">
                Show older notifications (<?php echo $notification_count - 5; ?>)
            </button>
            <div class="collapse mt-2" id="olderNotificationsAdmin">
                <ul class="list-group list-group-flush">
