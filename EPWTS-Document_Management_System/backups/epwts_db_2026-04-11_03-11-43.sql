...
INSERT INTO `backup_logs` (`id`, `backup_type`, `created_by`, `file_path`, `file_size`, `file_count`, `status`, `notes`, `created_at`) VALUES ('1', 'database', 'admin', '../../backups/epwts_db_2026-04-11_03-07-32.sql', '8699', '0', 'success', NULL, '2026-04-11 11:07:32');
INSERT INTO `backup_logs` (`id`, `backup_type`, `created_by`, `file_path`, `file_size`, `file_count`, `status`, `notes`, `created_at`) VALUES ('2', 'files', 'admin', '../../backups/files/backup_2026-04-11_03-11-21/', NULL, '5', 'success', NULL, '2026-04-11 11:11:21');
...
INSERT INTO `documents` (`id`, `doc_id`, `file_name`, `file_path`, `section`, `doc_type`, `uploaded_by`, `upload_date`, `expiry_date`, `description`) VALUES ('1', 'AB260504001', 'page 4.png', '../uploads/page 4.png', 'AB', NULL, NULL, '2026-04-05 10:13:07', NULL, NULL);
INSERT INTO `documents` (`id`, `doc_id`, `file_name`, `file_path`, `section`, `doc_type`, `uploaded_by`, `upload_date`, `expiry_date`, `description`) VALUES ('3', 'CW260504002', 'page 8.png', '../uploads/page 8.png', 'CW', NULL, NULL, '2026-04-05 10:23:08', NULL, NULL);
INSERT INTO `documents` (`id`, `doc_id`, `file_name`, `file_path`, `section`, `doc_type`, `uploaded_by`, `upload_date`, `expiry_date`, `description`) VALUES ('4', 'AB260504004', ' ABbbcc7732', '../uploads/Infectious Disease Test 1.png', 'Arch_Building', NULL, NULL, '2026-04-05 11:57:14', NULL, NULL);
INSERT INTO `documents` (`id`, `doc_id`, `file_name`, `file_path`, `section`, `doc_type`, `uploaded_by`, `upload_date`, `expiry_date`, `description`) VALUES ('5', 'CW260604001', 'Civil Works First File Upload', '../uploads/Serology 1.png', 'Civil_Works', NULL, NULL, '2026-04-06 23:05:04', NULL, NULL);
